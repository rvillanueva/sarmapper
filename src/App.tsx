...
class App extends React.Component {
  ...
  componentDidMount() {
    const behavior = this.profiles.getClosestBehaviorByHierarchy([
      "hiker",
      "temperate",
      "mtn",
    ]);
    ...
    searchMap.on("move", () =>
      this.props.updateMapCenter(searchMap.getLngLat()),
    );
        ...
        <div className="app-content">
          ...
          <div className="map-container">
            ...
            <div className="sidebar-toggle-container">
              ...
              >
                <FontAwesomeIcon
                  icon={this.state.sidebarIsOpen ? faCaretLeft : faCaretRight}
                />
              </div>
            </div>
          </div>
